...
const Header = () => {
  ...
  return (
    <header className="backdrop-blur-2x z-50 max-w-[75rem] mx-auto px-5 sm:px-[3%]">
      ...
      {/* mobile view */}
      <nav className={`${isNavMenuOpen ? 'translate-x-0' : '-translate-x-full'} sm:-translate-full transition-all duration-300 absolute w-[80%] bg-white/60 backdrop-blur top-0 left-0 h-screen pt-16 z-100`}>
